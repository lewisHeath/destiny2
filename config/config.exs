...
config :destiny2, Destiny2Web.Endpoint,
  ...
  render_errors: [
    formats: [html: Destiny2Web.ErrorHTML, json: Destiny2Web.ErrorJSON],
    layout: false
  ],
  pubsub_server: Destiny2.PubSub,
  live_view: [signing_salt: "D/PezEFS"]
...
config :destiny2, Destiny2.Mailer, adapter: Swoosh.Adapters.Local
