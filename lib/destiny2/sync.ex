defmodule Destiny2.Sync do
  ...
  defp sync_items(user, character_id, items_data, is_equipped) do
    Enum.each(items_data, fn item_data ->
      instance_id = item_data["itemInstanceId"]
      ...
      if instance_id do
        attrs = %{
          ...
          icon_path: nil,
          # Need instance data for this, usually component 300
          power_level: get_instance_power(item_data),
          user_id: user.id,
